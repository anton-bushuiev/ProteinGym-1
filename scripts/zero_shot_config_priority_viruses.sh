...
export DMS_data_folder_subs="${PROTEINGYM_CACHE}/viral_dms_substitutions" 
...
export DMS_reference_file_path_subs="${PROTEINGYM_CACHE}/reference_files/viral_dms_reference_proteingym_format.csv"
## Included in GitHub repo
...
export DMS_structure_folder="${PROTEINGYM_CACHE}/viral_dms_structures/"
