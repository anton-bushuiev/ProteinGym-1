...
export PROTEINGYM_CACHE="/scratch/project/open-35-8/data/priority-viruses/data"    
...
export DMS_data_folder_subs="${PROTEINGYM_CACHE}/who_virus_substitutions" 
...
export DMS_reference_file_path_subs="${PROTEINGYM_CACHE}/reference_files/who_virus_reference_proteingym_format.csv"
## Included in GitHub repo
...
export DMS_structure_folder="${PROTEINGYM_CACHE}/who_virus_structures/"
